...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
    return (
        <div className="min-h-screen bg-[#FDF9F2] flex font-sans">
            ...
            <div className="hidden lg:block lg:w-1/2 xl:w-5/12 h-screen sticky top-0 min-w-0">
                <AuthSidePanel />
            </div>

            {/* Right Side: Dynamic Form Area */}
            <div className="w-full lg:w-1/2 xl:w-7/12 flex items-center justify-center p-6 sm:p-12 min-w-0">
